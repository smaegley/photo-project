...
// OSM raster; in dark mode a CSS filter on the canvas inverts it to a dark map
// while keeping OSM's strong line/label contrast (see styles.css .maplibregl-canvas).
const OSM_STYLE = {
  version: 8,
  sources: {
    osm: {
